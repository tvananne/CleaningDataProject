...
# Initialize script variables *********************************************************************************** 
       library(data.table)
       file.loc <- '~/Analytics/Coursera/03 Getting and Cleaning Data/CourseProjData/UCI HAR Dataset/' #set your location for data files
...
# Combine TEST data ********************************************************************************************
       ...
       Y_test <- fread("~/Analytics/Coursera/03 Getting and Cleaning Data/CourseProjData/UCI HAR Dataset/test/y_test.txt")
...
# Combine TRAIN data *******************************************************************************************
       X_train <- fread("~/Analytics/Coursera/03 Getting and Cleaning Data/CourseProjData/UCI HAR Dataset/train/X_train.txt")
       ...
       Y_train <- fread("~/Analytics/Coursera/03 Getting and Cleaning Data/CourseProjData/UCI HAR Dataset/train/y_train.txt")
       colnames(activity_labels) <- c(activityNumber, 'actyLabel')
...
# Combine TEST and TRAIN into combined *****************************************************************************************************************     
